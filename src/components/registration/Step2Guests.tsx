...
export default function Step2Guests({
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <Image src="/images/plus-sign.svg" alt="Add Guest" width={16} height={16} />
      ...
      {guests.map((guest) => (
        <div key={guest.id} className="flex items-end space-x-4">
          ...
          <button
            ...
            className="text-gray-400 hover:text-red-500 transition-colors cursor-pointer mb-1"
          >
            <Image src="/images/delete-icon.svg" alt="Remove Guest" width={40} height={40} />
          </button>
        </div>
      ))}
    </div>
